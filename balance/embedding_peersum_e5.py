...
if __name__ == "__main__":
    ...
    for i, sample in tqdm(enumerate(samples), total=len(samples)):
        ...
        zeroshot_embeddings = get_embeddings_openai(zeroshot_sentences, client)
        ...
        finetuned_embeddings = get_embeddings_openai(finetuned_sentences, client)
    ...
    with jsonlines.open(os.path.join("peersum_embeddings_e5.jsonl"), "w") as writer:
