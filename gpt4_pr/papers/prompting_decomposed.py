"""
Implementation of the sentiment consolidation work with a prompt following the consolidation framework
"""
...
def meta_generation(source_documents: List) -> (str, str):
    ...
    prompt_content = f"Please give me steps to write a summary for the following reviews on an academic paper.\n\n Reviews on a paper:\n {source_text}\n\nThe steps to write a summary in different lines:"
    # print(prompt_format)
    while True:
        try:
