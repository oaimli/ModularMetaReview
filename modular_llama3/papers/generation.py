...
def gpt4_prompting(metas_generated: List):
    prompt_format = open("../../optimization/generation/prompt_generation_scientific.txt").read()
...
if __name__ == "__main__":
    ...
    with open(f"peermeta_reasoning_result_{model_name}.json") as f:
    ...
    print(len(results))
    with open(f"peermeta_generation_result_{model_name}.json", "w") as f:
